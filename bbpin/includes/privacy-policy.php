...
This Privacy Policy governs the manner in which <?php echo SITE_NAME;?> collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="<?php echo DOMAIN;?>"><?php echo SITE_NAME;?></a> website ("Site"). This privacy policy applies to the Site and all products and services offered by <?php echo SITE_NAME;?>.<br><br>
...
<?php echo SITE_NAME;?> collects and uses Users personal information for the following purposes:<br>
<ul>
...
The email address Users provide will only be used to respond to their inquiries, and/or other requests or questions. </li>
</ul>
...
By using this Site, you signify your acceptance of this policy and <a href="<?php echo DOMAIN;?>/terms.html">terms of service</a>. If you do not agree to this policy, please do not use our Site. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes.<br><br>

<b>Contacting us</b><br><br>

If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us at:<br>
<a href="<?php echo DOMAIN;?>contact-us.html"><?php echo DOMAIN;?>contact-us.html</a><br>

<br>
This document was last updated on May 07, 2012<br><br>
</div>