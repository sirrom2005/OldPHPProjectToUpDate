<?php
	...
	$presult = $comObj->getData("odb_faqs",NULL,"date_added","DESC");
	...
	$paginationUrl = "index.php?action=list_faqs";
	$p 			= new Pagination($page,$_LIMIT,$totalrows,$paginationUrl,5);
	$results 	= $p->getPaginatedResults($presult);
	
	if(empty($results)){ echo "<span class='err'>No records found...</span>"; return false; }
?>
<table>
...
?>
    <tr class="<?php echo $style;?>">
        <td>
        <a href="javascript:removefaq(<?php echo $row['id'] ?>); " ><img src="../images/icon-delete.gif"></a>
        <a href="index.php?action=add_faq&id=<?php echo $row['id'] ?>" ><img src="../images/application_edit.png"></a>
        </td>
...
function removefaq(id)
{
	...
	{
		window.location = "index.php?action=delete_faq&id=" + id;
	}	
}
</script>