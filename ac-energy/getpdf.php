...
{
    $query = "select text0,text1,text2,text3,text4,text5,text6,filename from quote_list where id = '$key'";
...
header("location: quote_listing.php?pdf=".base64_encode($row['filename']));
//============================================================+
// END OF FILE
//============================================================+
?>