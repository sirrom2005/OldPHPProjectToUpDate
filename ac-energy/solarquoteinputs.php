...
class Index extends common{
    ...
    protected function _load(){
        ...
        $rs = $this->db->execQuery("SELECT CONCAT(c.title,' ',c.firstname,' ',c.lastname) AS fullname, c.telephone, c.email,c.address,q.placetype,q.batteryquote,
                                    ...
                                    WHERE q.id=$id");
        $rt = $this->db->table("roof_section_quote","quote_id=?",$id);
