...
<hr class="space" />
<button class="button bmm" onclick="location='off-grid.php'">New Off Grid PV Quote</button>
<table id="datatable" class="rax-table column border">
    <caption>Off Grid PV Quote Listing</caption>
    <thead>
       <tr class="tbl-header">
            <th>Client Name</th>
            <th>Email</th>
    ...
    <tbody>
        <tr class="{ROWCLASS}">
            ...
            <td class="c6">
            	<a class="edit" href="offgridquoteinputs.php?id={id}" title="view form inputs for this qoute"></a>
                <a class="preview" href="off-grid-preview.php?id={id}" title="preview/edit document"></a>
