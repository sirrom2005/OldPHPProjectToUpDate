...
<fieldset>
	<legend>Off Grid PV Info</legend>
    <div id="flashfrm"></div>
    <p>
    ...
    <div id="sections">
        ...
        <div id="divsec4" style="display:none;">
            ...
            <p>
                <label for="img_upload1">Upload Images 1</label>
                <input type="file" class="textbox" name="img_upload1" id="img_upload1" value="" />
            </p>
            <p>
                <label for="img_upload2">Upload Images 2</label>
                <input type="file" class="textbox" name="img_upload2" id="img_upload2" value="" />
            </p>
            <p>
                <label for="img_upload3">Upload Images 3</label>
                <input type="file" class="textbox" name="img_upload3" id="img_upload3" value="" />
            </p>
            <p>
