...
<div id="padbox">
		...
		<br class="clear" />
        <div style="padding:10px 0 0 300px;margin:5px auto;">
            <span>
                <!-- AddThis Button BEGIN -->
                <div class="addthis_toolbox addthis_default_style ">
                <a class="addthis_button_facebook_like" fb:like:layout="button_count" fb:like:href="http://partyaad.com/index.php?p=bill-board" ></a>
                <a class="addthis_button_tweet" tw:url="http://partyaad.com/index.php?p=bill-board" ></a>
