	...
	<div id="padbox">
		...
		<div id="images">
			<?php while (next_image()): $c++; ?>
				<div class="image">
					<div class="imagethumb"><a href="<?php echo $_zp_current_image->webpath; ?>" title="<?php echo getBareImageTitle(); ?>" class="lightview" data-lightview-group="album" data-lightview-title="Photo Gallery Images" data-lightview-caption="<?php echo getBareImageTitle(); ?>"><?php printImageThumb(getAnnotatedImageTitle()); ?></a></div>
				</div>
			<?php endwhile; ?>
		</div>
		<br clear="all" />
