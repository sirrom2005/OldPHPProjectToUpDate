...
<div id="padbox">
		...
		<br class="clear" />
        <div class="fb-like" style="padding-top:5px; margin-left:400px;" data-href="http://partyaad.com/index.php?p=up-coming-events" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true" data-font="arial"></div>
		<?php } ?>
	</div>
    <br class="clear" />
    <!--ul id="menu">
