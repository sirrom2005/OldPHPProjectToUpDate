...
<div id="main">
    <div id="gallerytitle">
        ...
        <h2 id="gallerypage">
            <span>
                    <a href="index.php?p=gallery" title="<?php gettext('Albums Index'); ?>"><?php echo getGalleryTitle(); ?></a> |
                    <?php
    ...
    <div id="narrow">
    	<div class="fb-like" data-href="http://partyaad.com/index.php?album=<?php echo $_zp_current_image->album->name;?>&image=<?php echo $_zp_current_image->filename;?>" data-send="true" data-layout="button_count" data-width="450" data-show-faces="true" data-font="arial"></div>
