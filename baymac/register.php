          ...
          <form action="" method="post" id="form_register">
            ...
            ?>
              ...
              <li>
				...
				<input type="hidden" name="country_code" id="country_code" value="filler"/>
                <select id="country" name="country" class="text inplaceError">
                <option value=" " selected>(please select a country)</option>
                <?php 
                asort($countries);
                foreach($countries as $id => $country) {
                    echo '<option value="'.strtolower($id).'">'.$country.'</option>';
                }
                ?>
                </select>
              ...
              <li>
                <label for="phone">Telephone - including country & area code (optional)<!--<sup style="color:red;">*</sup> (required)--></label>
