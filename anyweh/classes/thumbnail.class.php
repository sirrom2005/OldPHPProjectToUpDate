...
class thumbNail
{
	...
	*/
	...
	function thumbNail( $imgData )
	{
	    $this->path	= $_SERVER['DOCUMENT_ROOT'].$this->webFolder;
		$img 		= $imgData['image'];
		$w 	 		= $imgData['w'];
		$h   		= $imgData['h'];
	...
	function imageResize( $src, $dest=NULL, $w=110, $h=NULL )
	{
		...
		if( $this->ext == "jpg" )
		{
			imagejpeg($imgdest, NULL, $this->quality); 
		}
		if( $this->ext == "gif" )
		{ 
