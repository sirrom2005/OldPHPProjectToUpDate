...
$this->settings = array(
  ...
  'allowedExtensions'       => array('wmv','avi','mp4','mov','flv','3gp','mpg','WMV','AVI','MP4','MOV','FLV','3GP','MPG'),// an array of allowed file extensions
  ...
  'uploadDir'               => VIDEO_TMP_FOLDER,                     // a directory to put uploaded files into; it is strongly 
